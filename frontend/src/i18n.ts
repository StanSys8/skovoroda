...
const dict = {
  en: {
    ...
    pruneInstructions: 'clean up unused instructions',
    prunedNone: 'No unused instructions to clean up.',
    prunedSome: 'Removed unused instructions: {n}.',
  ...
  uk: {
    ...
    pruneInstructions: 'прибрати невживані інструкції',
    prunedNone: 'Невживаних інструкцій немає.',
    prunedSome: 'Прибрано невживаних інструкцій: {n}.',
